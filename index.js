...
// - Utilize a linguagem de programação de sua escolha para implementar o programa.
...
// - Verifique se a saída está correta e de acordo com a sequência de Fibonacci dada.
    ...
    // a criação de uma váriavel no loop vai indicar quantos numeros terão no array final
    for(var i = 0; result.length < 40; i++){

        result.push(count)
        
        //observei que os numero começavam a somar com o antecessor a partir do terceiro numero por isso fiz essa condição para somar sempre com antecessor usando o i como
        if(i > 1){
